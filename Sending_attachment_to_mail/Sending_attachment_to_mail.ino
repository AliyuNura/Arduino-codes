...
//  }
  ...
  */
  att.descr.filename = "iot.jpg";
  att.descr.mime = "iot/jpg"; //binary data
  att.file.path = "/iot.jpg";
  ...
  att.descr.filename = "SPIFFS.txt";
  att.descr.mime = "SPIFFS/plain";
  att.file.path = "/SPIFFS.txt";
  att.file.storage_type = esp_mail_file_storage_type_flash;
  att.descr.transfer_encoding = Content_Transfer_Encoding::enc_base64;
